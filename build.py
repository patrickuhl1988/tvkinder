...
PAGES["live"] = dict(
    ...
    <button class="allebtn" id="alleZeigen">Alle Sendungen anzeigen</button>
...
function apply(){
  ...
  const teaser = kompakt && fGroup==="all" && !suche;
...
(function(){
  const KANDIDATEN=[
    ...
    {img:"banner-tvfussball.png", href:"https://tvfussball.de", ext:true, cap:"slide_tvf"},
    {img:"banner-muehle.png", href:"https://play.google.com/store/apps/details?id=app.muehle.muehle&utm_source=tvk_hero", ext:true, cap:"slide_mm"},
    {img:"banner-memory.png", href:"memory.html", cap:"slide_mem"},
    {img:"banner-abend.png", href:null, cap:null}
  ];
