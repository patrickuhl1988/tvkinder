...
kurz/kurz_en = Kurzbeschreibung DE/EN, genre = Genre-Angabe."""

STAND = "09.08.2026"

KINO = [
    dict(t="Paw Patrol 3: Der Dino-Film", genre="Animation · Abenteuer", fsk="0", dauer=88, start="06.08.2026",
    ...
    dict(t="Toy Story 5", genre="Animation · Familie", fsk="0", dauer=102, start="23.07.2026",
         ...
         kurz_en="Woody, Buzz and Jessie face their biggest challenge yet: "
                 ...
                 "analogue toys."),
    dict(t="Minions & Monster", genre="Animation · Komödie", fsk="6", dauer=89, start="01.07.2026",
    ...
    dict(t="Vaiana", genre="Animation · Abenteuer", fsk="6", dauer=0, start="09.07.2026",
    ...
    dict(t="Chihiros Reise ins Zauberland", genre="Anime · Fantasy", fsk="0", dauer=125, start="13.08.2026",
    ...
    dict(t="Die Wilden Kerle 4", genre="Familie · Fußball", fsk="6", dauer=0, start="13.08.2026",
    ...
    dict(t="Marsupilami", genre="Animation · Komödie", fsk="6", dauer=99, start="20.08.2026",
    ...
    dict(t="Tad Stones und die Wunderlampe", genre="Animation · Abenteuer", fsk="", dauer=0, start="27.08.2026",
